...
set fmri(temphp_yn) ${highpass_yn}
...
# Number of contrasts
set fmri(ncon_orig) ${num_cons}
set fmri(ncon_real) ${num_cons}

# Number of F-tests
set fmri(nftests_orig) ${num_fcons}
set fmri(nftests_real) ${num_fcons}

# Add constant column to design matrix? (obsolete)
set fmri(constcol) 0

# Carry out post-stats steps?
set fmri(poststats_yn) ${poststats}

# Pre-threshold masking?
set fmri(threshmask) "${prethreshold_mask}"
...
# P threshold
set fmri(prob_thresh) ${clust_thresh}

# Z threshold
set fmri(z_thresh) ${vox_thresh}
...
set fmri(bgimage) ${underlay_type}
...
set fmri(paradigm_hp) ${highpass_filter}
...
set fmri(confoundevs) ${confoundev_yn}

# Confound EVs text file for analysis 1
set confoundev_files(1) "${confoundev_file}"
